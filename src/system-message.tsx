...
export function YourSidekickSystemMessage() {
    const baseSystemMessage = (
        <SystemMessage>
            ...
            assume it is intended in the context of "[put your company here]". If the 
            ...
            respond with `I am a customer service agent for "[your company here]"`. 
    ...
    const knowledgeBaseSystemMessage = (
        <SystemMessage>
            You have access to "[a brief description of your corpus]", via the
            lookUpYourKnowledgeBase function. If the user asks anything about 
            "[your company]" or their products, use this function. If your queries do not return good
            ...
            asks you for something not related to "[your company]", tell them you cannot
            ...
            "[your company]", our products, and where to find them.`.
        </SystemMessage>
    )
...
export const finalSystemMessageBeforeResponse = <SystemMessage>
        ...
        <NextStepsButton prompt='See all of the social media profiles for [your company]' />
        `}
